...
(*) descendent /diˈsendənt/: con cháu
-------------------------
...
1 abstract class chủ yếu định nghĩa khung cơ bản của 1 entity đóng gói cụ thể - ví dụ, bạn có thể dùng abtrac class để định nghĩa khái niệm cơ bản của 1 "car" là có 2 cửa, 1 khóa và 1 method để khóa hay mở khóa cửa
Abtract classes không thể dùng trực tiếp, nhưng có thể EXTENDES để lớp con cung cấp đầy đủ các method. Ví dụ:
...
Lưu ý cách menthods này không thực sự có nội dung - đó là một trong các yêu cầu của abstract classes - và cách class đó phải được khai báo là abstract để trình biên dịch đáp ứng các yêu cầu cú pháp của trình phân tích cú pháp.
-------------------------
(*) satisfy /ˈsætəsˌfaɪ/
